...
alias dfg='cd ~/github/repos/dotfiles && git pull --force && cd ~/ && cp .agignore .bash_aliases .bash_profile .bash_prompt .bashrc .editorconfig .exports .functions .gemrc .gitattributes .gitignore .gvimrc .hgignore .hushlogin .npmrc .path .profile .tmux.conf .vimrc ~/github/repos/dotfiles/elcapitan && cd ~/github/repos/dotfiles/elcapitan && git status'
